...
ax.set_title("广州二手房房屋户型占比情况", fontsize=18)
count_fwhx.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/广州二手房房屋户型占比情况.jpg')
plt.show()
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("广州二手房装修占比情况", fontsize=18)
count_zxqk.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/广州二手房装修占比情况.jpg')
plt.show()
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("广州二手房建筑类型占比情况", fontsize=18)
count_jzlx.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/广州二手房建筑类型占比情况.jpg')
plt.show()
...
plt.savefig('../data_ana/picture/房源朝向分布情况.jpg')
plt.show()
...
ax.set_title("广州二手房建筑面积分布区间",fontsize=18)
jzmj_result.plot(kind="barh",fontsize=12)
plt.savefig('../data_ana/picture/广州二手房建筑面积分布区间.jpg')
plt.show()
