...
ax.set_title("广州各区域二手房平均单价", fontsize=18)
mean_unitprice.plot(kind="bar", fontsize=12)
plt.savefig('../data_ana/picture/广州各区域二手房平均单价.jpg')
plt.show()
...
ax.set_title("广州各区域二手房平均建筑面积", fontsize=18)
mean_jzmj.plot(kind="bar", fontsize=12)
plt.savefig('../data_ana/picture/广州各区域二手房平均建筑面积.jpg')
plt.show()
...
ax.set_title("广州各区域二手房房源数量", fontsize=18)
count_area.sort_values().plot(kind="line", fontsize=12, grid=True, marker="o")
plt.savefig('../data_ana/picture/广州各区域二手房房源数量.jpg')
plt.show()
...
ax = fig.add_subplot(111)
ax.set_ylabel("单价(元/平米)", fontsize=14)
ax.set_title("广州二手房单价最高Top20", fontsize=18)
unitprice_top["unitPriceValue"].plot(kind="barh", fontsize=12)
plt.savefig('../data_ana/picture/广州二手房单价最高TOP20.jpg')
plt.show()

"""广州二手房总价与建筑面积散点图"""
fig = plt.figure(figsize=(12, 7))
ax = fig.add_subplot(111)
ax.set_title("广州二手房总价与建筑面积散点图", fontsize=18)
...
ax.set_ylabel("总价(万元)", fontsize=14)
plt.savefig('../data_ana/picture/广州二手房总价与建筑面积散点图.jpg')
plt.show()

"""广州二手房单价与建筑面积散点图"""
fig = plt.figure(figsize=(12,7))
ax = fig.add_subplot(111)
ax.set_title("广州二手房单价与建筑面积散点图", fontsize=18)
...
ax.set_xlabel("建筑面积(㎡)", fontsize=14)
ax.set_ylabel("单价(元/平米)", fontsize=14)
plt.savefig('../data_ana/picture/广州二手房单价与建筑面积散点图.jpg')
plt.show()
